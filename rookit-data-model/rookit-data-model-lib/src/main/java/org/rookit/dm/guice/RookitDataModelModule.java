...
import org.rookit.dm.RookitModelModule;
...
public final class RookitDataModelModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        // Dozer binding
        OptionalBinder.newOptionalBinder(binder(), Mapper.class).setDefault()
                .toProvider(DozerBeanMapperBuilder::buildDefault);
    }

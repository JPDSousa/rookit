...
public final class TrackModule extends AbstractModule {
    ...
    protected void configure() {
        bind(TrackFactory.class).to(TrackFactoryImpl.class).in(Singleton.class);
        bind(VersionTrackFactory.class).to(VersionTrackFactoryImpl.class).in(Singleton.class);
    }
}

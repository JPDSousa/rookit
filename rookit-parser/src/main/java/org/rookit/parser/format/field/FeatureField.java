...
final class FeatureField extends AbstractArtistField {

    static final String NAME = "FEAT";

    @Inject
    private FeatureField(final StringUtils stringUtils,
    ...
    protected void applyArtists(final TrackSlotAccumulator trackSlotAccumulator, final Collection<Artist> artists) {
        trackSlotAccumulator.getTrackAccumulator().addFeatures(artists);
    }
